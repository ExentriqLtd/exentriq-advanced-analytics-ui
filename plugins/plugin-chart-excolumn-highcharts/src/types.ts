...
export interface ExcolumnHighchartsStylesProps {
  height: number;
  width: number;
...
export type ExcolumnHighchartsQueryFormData = QueryFormData &
  ExcolumnHighchartsStylesProps &
  ExcolumnHighchartsCustomizeProps;

export type ExcolumnHighchartsProps = ExcolumnHighchartsStylesProps &
  ExcolumnHighchartsCustomizeProps & {
